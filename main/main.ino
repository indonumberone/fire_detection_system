...
#define GAS_SAFE 5     // Level gas aman
#define GAS_WARNING 100   // Level gas peringatan
#define GAS_DANGER 300   // Level gas bahaya
#define GAS_CRITICAL 500  // Level gas kritis
